                ...
                for e in range(epochs):
                    ...
                    for i in range(len(mini_batch_shapes)):
                        ...
                        if x_batch_split.size != 0 :
                            ...
                            dims = []
                            print("rank: ", rank , "x_batch_split: ", x_batch_split)
                            comm.Barrier()
                            print("")
                            comm.Barrier() 
                            ...
                            for layer in layers:
                                ...
                                print("rank: ", rank , "layer", layer_count, "w: ", layer.w)
                                comm.Barrier()
                                print("")
                                comm.Barrier()

                                print("rank: ", rank , "layer", layer_count, "b: ", layer.b)
                                comm.Barrier()
                                print("")
                                comm.Barrier()

                                print("rank: ", rank , "layer", layer_count, "x_rank: ", z_rank)
                                comm.Barrier()
                                print("")
                                comm.Barrier()     
                                ...
                                print("rank: ", rank , "layer", layer_count, "x_gathered: ", z_batch_split)
                                comm.Barrier()
                                print("")
                                comm.Barrier() 
                            ...
                            print("rank: ", rank , "dy_batch_split: ", dy_batch_split)
                            comm.Barrier()
                            print("")
                            comm.Barrier() 
                            ...
                            for layer in reversed(layers):
                                if layer.w.size != 0:
                                    ...
                                    print("rank: ", rank , "layer", layer_count, "dy_sliced: ", dy_rank)
   
                                    dx_rank, dw_rank, db_rank = layer.backward(dy_rank)
                                    print("rank: ", rank , "layer", layer_count, "dx_rank: ", dx_rank)


                                    print("rank: ", rank , "layer", layer_count, "dw_rank: ", dw_rank)


                                    print("rank: ", rank , "layer", layer_count, "db_rank: ", db_rank)
                                    ...
                                    print("rank: ", rank , "layer", layer_count, "dw_reduced: ", dw_model_split)

                                    print("rank: ", rank , "layer", layer_count, "db_reduced: ", db_model_split)
                                ...
                                print("rank: ", rank , "layer", layer_count, "dx_reduced: ", dx_batch_split)
                                comm.Barrier()
                                print("")
                                comm.Barrier()
